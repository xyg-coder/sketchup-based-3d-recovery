...
Point3 Normalize(const Point3&);  // Accurate normalize
...
Point3 FNormalize(const Point3&); // Fast normalize 
...
Point3 CrossProd(const Point3& a, const Point3& b);  // CROSS PRODUCT
